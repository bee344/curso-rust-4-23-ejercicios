    ...
    for r in results.lines() {
        ...
        match scores.get(&team_1_name) {
            ...
            Some(team) => {
                team_1 = Team {
                    name: team_1_name.clone(),
                    goals_scored: team.goals_scored + team_1_score.clone(),
                    goals_conceded: team.goals_conceded + team_2_score.clone(),
                };
            }
        }
         match scores.get(&team_2_name) {
            ...
            Some(team) => {
                team_2 = Team {
                    name: team_2_name.clone(),
                    goals_scored: team.goals_scored + team_2_score.clone(),
                    goals_conceded: team.goals_conceded + team_1_score.clone(),
                };
            }
        }
